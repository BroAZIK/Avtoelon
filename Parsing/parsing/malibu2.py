...
def malibu2():
    ...
    for num_page in range(1, 2):
        html = get_page(f"https://avtoelon.uz/uz/avto/chevrolet/malibu2/?page={num_page}")
        htmldom = BeautifulSoup(html.text, "lxml")
    

        items = get_items(htmldom)
        url = "https://azizbek4.pythonanywhere.com/api/cars/malibu2/"
        fin_file = []
